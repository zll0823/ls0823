Laro.register('JxHome', function (La) {
	...
	{
		this.qqParticles = this.getParticles('youtext',31,19);
		this.jxParticles = this.getParticles('designIco',32,17);
		this.qplusParticles = this.getParticles('h5ico',68,11);
		this.atParticles = this.getParticles('cs3',87,15);
